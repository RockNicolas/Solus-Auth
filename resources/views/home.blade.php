...
<body class="bg-gradient-to-r from-[#008070] to-[#800042]">
  <header class="h-16 flex items-center justify-between p-0 px-5 fixed top-0 left-0 w-full z-50 bg-blue-500"> <!-- Alterado para bg-blue-500 -->
